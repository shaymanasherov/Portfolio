                ...
                <div className="row">
                    <div className="col-lg-8 mx-auto">
                        ...
                        <form id="contactForm" name="sentMessage" novalidate="novalidate">
                            ...
                            <br />
                            <div id="success"></div>
                            <div className="form-group"><button className="btn btn-primary btn-xl" id="sendMessageButton" type="submit" onClick={e => this.submitForm}>Send</button></div>
                        </form>
                    </div>
                </div>
            </div>
